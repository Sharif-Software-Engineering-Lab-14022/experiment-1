    ...
    return <div className="flex items-center justify-center w-full h-[calc(100vh-165px)]">
        <div
            ...
            <div className="grid grid-cols-4 gap-4 w-full">
                <button className="col-span-2 flex item-center justify-center bg-gray-300 hover:bg-gray-400 p-4 rounded-[10px] text-xl">
                    AC
                </button>
                <button className="flex item-center justify-center bg-gray-300 hover:bg-gray-400 p-4 rounded-[10px] text-xl">
                    C
                </button>
                ...
                <NumberButton number={'.'}/>
                <button className="flex item-center justify-center bg-green-500 hover:bg-green-600 p-4 rounded-[10px] text-xl">
                    =
                </button>
            </div>
